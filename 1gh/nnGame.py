...
class Game:
    def __init__(self, seed, n, K, K2, K3):
        ...
        torch.nn.init.uniform_(self.f.input_linear[0].weight, a=self.lb, b=self.ub)
        torch.nn.init.uniform_(self.f.input_linear[1].weight, a=self.lb, b=self.ub)
        torch.nn.init.uniform_(self.f.input_linear[2].weight, a=self.lb, b=self.ub)
    def printGame(self):
